...
export class UpholsteryService {
  ...
  constructor(private afs: AngularFirestore, private authService: AuthService) {
    ...
    //databse connection
    this.dbcollections = this.afs.doc(`Upholstery/${this.CurrentUser.uid}`);
    //setting up form with formgroup
    this.form = new FormGroup({
      occupation: new FormControl("upholstery", Validators.required),
