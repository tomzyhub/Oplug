...
export class AirconditionRepairsService {
  ...
  constructor(private afs: AngularFirestore, private authService: AuthService) {
    ...
    this.dbcollections = this.afs.doc(
      `Aircondition-Repairs/${this.CurrentUser.uid}`
    );
    //setting up form with formgroup
    this.form = new FormGroup({
      occupation: new FormControl("Aircondition-Repairs", Validators.required),
  ...
  initializeFormGroup() {
    this.form.setValue({
      occupation: "Aircondition-Repairs",
      country: "",
      state: "",
      city: "",
      phonenumber: ""
