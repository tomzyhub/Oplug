...
export class RefridgeratorRepairService {
  ...
  constructor(private afs: AngularFirestore, private authService: AuthService) {
    ...
    this.dbcollections = this.afs.doc(
      `Refridgerator-Repair/${this.CurrentUser.uid}`
    );
    //setting up form with formgroup
    this.form = new FormGroup({
      occupation: new FormControl("Refridgerator-Repair", Validators.required),
  ...
  initializeFormGroup() {
    this.form.setValue({
      occupation: "Refridgerator-Repair",
      country: "",
      state: "",
      city: "",
      phonenumber: ""
