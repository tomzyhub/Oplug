...
export class VulcanizersService {
  ...
  constructor(private afs: AngularFirestore, private authService: AuthService) {
    ...
    //databse connection
    this.dbcollections = this.afs.doc(`Vulcanizers/${this.CurrentUser.uid}`);
    //setting up form with formgroup
    this.form = new FormGroup({
      occupation: new FormControl("Vulcanizers", Validators.required),
