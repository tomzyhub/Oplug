...
export class CybercafeService {
  ...
  constructor(private afs: AngularFirestore, private authService: AuthService) {
    ...
    //databse connection
    this.dbcollections = this.afs.doc(`Cyber-cafe/${this.CurrentUser.uid}`);
    //setting up form with formgroup
    this.form = new FormGroup({
      occupation: new FormControl("Cyber-Cafe", Validators.required),
