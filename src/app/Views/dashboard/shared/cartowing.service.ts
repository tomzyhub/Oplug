...
export class CartowingService {
  ...
  constructor(private afs: AngularFirestore, private authService: AuthService) {
    ...
    //databse connection
    this.dbcollections = this.afs.doc(`Cartowing/${this.CurrentUser.uid}`);
    //setting up form with formgroup
    this.form = new FormGroup({
      occupation: new FormControl("Car-Towing", Validators.required),
